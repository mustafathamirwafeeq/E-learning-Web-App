    ...
    public class CourseClassesController : Controller
    {
        ...
        public async Task<ActionResult> Index(int? id)
        {
            ...
            if (id != null)
            {
                ...
                {
                    var courseClass = Utilities.GetStudentClasses(id.ToString());
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.InstructorId = new SelectList(Utilities.GetUsersByRole("Moderator"), "UserId", "UserName");
            return View();
        }
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            ViewBag.TrainingBaseId = new SelectList(db.TrainingBase, "Id", "Name", courseClass.TrainingBaseId);
            ViewBag.InstructorId = new SelectList(Utilities.GetUsersByRole("Moderator"), "UserId", "UserName", courseClass.InstructorId);
            return View(courseClass);
        }
        ...
        public async Task<ActionResult> RecentClasses()
        {
            ...
            {
                int instructorID = Utilities.GetCurrentUserId();
        ...
        {
            int userId = Utilities.GetCurrentUserId();
            var students = Utilities.GetUsersByRole("Student");
            var courseClass = db.CourseClass.FirstOrDefault(x => x.Id == id);
            ViewBag.Title = courseClass.Title;
            ViewBag.Instructor = Utilities.GetUserFullName(courseClass.InstructorId);
            ...
            ViewBag.ID = id;
            ViewBag.Students = new SelectList(students.Select(x => new { UserId = x.UserId, UserName = x.UserName + "-" + x.FullName }), "UserId", "UserName");
            return View();
        }
        ...
        {
            ViewBag.StudentId = Utilities.GetCurrentUserId();
        ...
        {
            string uid = Utilities.GetCurrentUserId().ToString();
        ...
        public ActionResult SetClassDates(int id, bool isHolidays = false, bool isWeekHolidays = false)
        {
            var cls = db.CourseClass.FirstOrDefault(x => x.Id == id);
            ...
            ViewBag.ClassName = cls.Title + " classes details";
            ViewBag.ID = id;
